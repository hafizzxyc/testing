...
const expiredCheck = (kuze, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            kuze.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( res => {
              kuze.groupLeave(_dir[position].id)
